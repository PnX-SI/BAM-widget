...
- Widget integration examples:
  - [Basic examples](https://pnx-si.github.io/BAM-widget/examples/basic-examples.html) / [Source code](https://github.com/PnX-SI/BAM-widget/blob/main/examples/basic-examples.html)
  - [Ecrins huts and biodiversity](https://pnx-si.github.io/BAM-widget/examples/huts-biodiversity.html) / [Source code](https://github.com/PnX-SI/BAM-widget/blob/main/examples/huts-biodiversity.html)
  - [Falkensee schools and biodiversity](https://pnx-si.github.io/BAM-widget/examples/falkensee-schools-biodiversity.html) / [Source code](https://github.com/PnX-SI/BAM-widget/blob/main/examples/falkensee-schools-biodiversity.html)
  - [Jamaican biodiversity](https://pnx-si.github.io/BAM-widget/examples/jamaican-biodiversity.html) / [Source code](https://github.com/PnX-SI/BAM-widget/blob/main/examples/jamaican-biodiversity.html)
  - [Corcovado treks](https://pnx-si.github.io/BAM-widget/examples/corcovado-treks.html) / [Source code](https://github.com/PnX-SI/BAM-widget/blob/main/examples/corcovado-treks.html)
  ...
  - [GeoNature demo instance observations in South France](https://pnx-si.github.io/BAM-widget/examples/geonature-demo-widget.html) / [Source code](https://github.com/PnX-SI/BAM-widget/blob/main/examples/geonature-demo-widget.html)
