    ...
    <div class="col detailed" data-testid="Taxon detailed view">
        <div class="card h-100 mb-2">
            ...
            <div class="card-body">
                <!-- Taxon Names -->
                <div class="names">
                    <strong class="vernacular-name">{{ props.vernacularName }}</strong>
                    <em class="scientific-name">{{ props.acceptedScientificName }}</em>
                </div>

                <!-- Status Badge -->
                <div v-if="props.status" class="status-wrapper">
                    <StatusIcon
                ...
                <div class="statistics-wrapper">
                    <div class="statistics">
                        <small class="text-body-secondary">{{ $t('taxon.lastSeenDate') }}</small>
                        <strong>{{ props?.lastSeenDate.toLocaleDateString() }}</strong>
                    </div>
                    <div v-if="props.nbObservations" class="statistics">
                        <small class="text-body-secondary">{{ $t('taxon.nbObservations') }}</small>
                        <strong>{{ props.nbObservations }}</strong>
                    </div>
                </div>

                <!-- Description Button -->
                <div v-if="props.description" class="description-button-wrapper">
                    <BButton
            ...
            <div class="credits">
                <div class="credits-header">
                    <h6 class="mb-0">
                        <i class="bi bi-link-45deg"></i> {{ $t('taxon.credits') }}
                    </h6>
                </div>
