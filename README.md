...
| `placeName`        | string  | A place name used to fetch coordinates. Coordinates are fetched using the Nominatim API (https://nominatim.openstreetmap.org)                                                                                                | `Cherbourg-en-Cotentin`          |
